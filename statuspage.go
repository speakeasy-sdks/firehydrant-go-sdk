...
func newStatuspage(sdkConfig sdkConfiguration) *Statuspage {
	return &Statuspage{
...
func (s *Statuspage) UpdateConnection(ctx context.Context, connectionID string, patchV1IntegrationsStatuspageConnectionsConnectionID components.PatchV1IntegrationsStatuspageConnectionsConnectionID, opts ...operations.Option) (*operations.UpdateStatuspageConnectionResponse, error) {
