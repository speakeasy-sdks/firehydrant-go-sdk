...
func newCatalogs(sdkConfig sdkConfiguration) *Catalogs {
	return &Catalogs{
...
func (s *Catalogs) Ingest(ctx context.Context, catalogID string, postV1CatalogsCatalogIDIngest components.PostV1CatalogsCatalogIDIngest, opts ...operations.Option) (*operations.IngestCatalogDataResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "PostV1CatalogsCatalogIDIngest", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
