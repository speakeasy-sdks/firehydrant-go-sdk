...
func (s *Connections) Create(ctx context.Context, request operations.PostV1NuncConnectionsRequestBody, opts ...operations.Option) (*operations.PostV1NuncConnectionsResponse, error) {
