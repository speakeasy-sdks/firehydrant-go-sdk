...
type FireHydrantStatuspage struct {
	sdkConfiguration sdkConfiguration
}

func newFireHydrantStatuspage(sdkConfig sdkConfiguration) *FireHydrantStatuspage {
	return &FireHydrantStatuspage{
...
func (s *FireHydrantStatuspage) ListConnections(ctx context.Context, page *int, perPage *int, opts ...operations.Option) (*operations.ListStatuspageConnectionsResponse, error) {
...
func (s *FireHydrantStatuspage) ListPages(ctx context.Context, connectionID string, opts ...operations.Option) (*operations.ListStatuspagePagesResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
