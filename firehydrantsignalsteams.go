...
type FireHydrantSignalsTeams struct {
	sdkConfiguration sdkConfiguration
}

func newFireHydrantSignalsTeams(sdkConfig sdkConfiguration) *FireHydrantSignalsTeams {
	return &FireHydrantSignalsTeams{
...
func (s *FireHydrantSignalsTeams) GetEscalationPolicy(ctx context.Context, teamID string, id string, opts ...operations.Option) (*operations.GetTeamEscalationPolicyResponse, error) {
