...
func newConfluence(sdkConfig sdkConfiguration) *Confluence {
	return &Confluence{
...
func (s *Confluence) ListSpaces(ctx context.Context, id string, keyword *string, opts ...operations.Option) (*operations.ListConfluenceSpacesResponse, error) {
	...
	res := &operations.ListConfluenceSpacesResponse{
