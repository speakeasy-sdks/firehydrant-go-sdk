...
type AwsConnections struct {
	sdkConfiguration sdkConfiguration
}

func newAwsConnections(sdkConfig sdkConfiguration) *AwsConnections {
...
func (s *AwsConnections) List(ctx context.Context, request operations.ListAwsConnectionsRequest, opts ...operations.Option) (*operations.ListAwsConnectionsResponse, error) {
...
func (s *AwsConnections) Get(ctx context.Context, id string, opts ...operations.Option) (*operations.GetAwsConnectionResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
