...
type TicketingPriorities struct {
	sdkConfiguration sdkConfiguration
}

func newTicketingPriorities(sdkConfig sdkConfiguration) *TicketingPriorities {
	return &TicketingPriorities{
...
func (s *TicketingPriorities) Get(ctx context.Context, id string, opts ...operations.Option) (*operations.GetTicketingPriorityResponse, error) {
