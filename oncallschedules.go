...
func (s *OnCallSchedules) Delete(ctx context.Context, teamID string, scheduleID string, opts ...operations.Option) (*operations.DeleteTeamOnCallScheduleResponse, error) {
