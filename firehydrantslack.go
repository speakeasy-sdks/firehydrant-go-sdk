...
type FireHydrantSlack struct {
	sdkConfiguration sdkConfiguration
}

func newFireHydrantSlack(sdkConfig sdkConfiguration) *FireHydrantSlack {
	return &FireHydrantSlack{
...
func (s *FireHydrantSlack) GetEmojiAction(ctx context.Context, connectionID string, emojiActionID string, opts ...operations.Option) (*operations.GetSlackEmojiActionResponse, error) {
...
func (s *FireHydrantSlack) DeleteEmojiAction(ctx context.Context, connectionID string, emojiActionID string, opts ...operations.Option) (*operations.DeleteSlackEmojiActionResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *FireHydrantSlack) ListWorkspaces(ctx context.Context, connectionID string, opts ...operations.Option) (*operations.GetSlackWorkspacesResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	res := &operations.GetSlackWorkspacesResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
