...
func newCurrentUser(sdkConfig sdkConfiguration) *CurrentUser {
	return &CurrentUser{
...
func (s *CurrentUser) Get(ctx context.Context, opts ...operations.Option) (*operations.GetV1CurrentUserResponse, error) {
	...
	res := &operations.GetV1CurrentUserResponse{
