...
func (s *Metrics) GetInfrastructure(ctx context.Context, infraType operations.PathParamInfraType, infraID string, startDate *types.Date, endDate *types.Date, opts ...operations.Option) (*operations.GetInfrastructureMetricsResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
