...
func (o *GetV1RunbooksActionsResponse) GetHTTPMeta() components.HTTPMetadata {
	if o == nil {
...
func (o *GetV1RunbooksActionsResponse) GetRunbooksActionsEntityPaginated() *components.RunbooksActionsEntityPaginated {
	if o == nil {
		return nil
	}
