...
func (o *SetIncidentAlertAsPrimaryRequest) GetPatchV1IncidentsIncidentIDAlertsIncidentAlertIDPrimary() components.PatchV1IncidentsIncidentIDAlertsIncidentAlertIDPrimary {
	if o == nil {
...
func (o *SetIncidentAlertAsPrimaryResponse) GetHTTPMeta() components.HTTPMetadata {
	if o == nil {
...
func (o *SetIncidentAlertAsPrimaryResponse) GetIncidentsAlertEntity() *components.IncidentsAlertEntity {
	if o == nil {
		return nil
	}
