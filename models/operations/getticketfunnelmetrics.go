...
func (o *GetTicketFunnelMetricsResponse) GetHTTPMeta() components.HTTPMetadata {
	if o == nil {
...
func (o *GetTicketFunnelMetricsResponse) GetMetricsTicketFunnelMetricsEntity() *components.MetricsTicketFunnelMetricsEntity {
	if o == nil {
		return nil
	}
