...
func (o *UpdateIncidentImpactsRequest) GetPutV1IncidentsIncidentIDImpact() components.PutV1IncidentsIncidentIDImpact {
	if o == nil {
...
func (o *UpdateIncidentImpactsResponse) GetHTTPMeta() components.HTTPMetadata {
	if o == nil {
...
func (o *UpdateIncidentImpactsResponse) GetIncidentEntity() *components.IncidentEntity {
	if o == nil {
		return nil
	}
