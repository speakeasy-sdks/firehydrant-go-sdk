...
func (o *GetSignalIngestURLResponse) GetHTTPMeta() components.HTTPMetadata {
	if o == nil {
...
func (o *GetSignalIngestURLResponse) GetSignalsAPIIngestKeyEntity() *components.SignalsAPIIngestKeyEntity {
	if o == nil {
		return nil
	}
