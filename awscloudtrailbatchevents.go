...
type AwsCloudtrailBatchEvents struct {
	sdkConfiguration sdkConfiguration
}

func newAwsCloudtrailBatchEvents(sdkConfig sdkConfiguration) *AwsCloudtrailBatchEvents {
	return &AwsCloudtrailBatchEvents{
		sdkConfiguration: sdkConfig,
	}
}

// List events for an AWS CloudTrail batch
func (s *AwsCloudtrailBatchEvents) List(ctx context.Context, id string, opts ...operations.Option) (*operations.GetAwsCloudtrailBatchEventsResponse, error) {
	...
	res := &operations.GetAwsCloudtrailBatchEventsResponse{
