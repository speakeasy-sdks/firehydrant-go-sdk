...
func (s *StatusUpdateTemplates) Create(ctx context.Context, request components.PostV1StatusUpdateTemplates, opts ...operations.Option) (*operations.CreateStatusUpdateTemplateResponse, error) {
