...
func newProjectConfigurations(sdkConfig sdkConfiguration) *ProjectConfigurations {
...
func (s *ProjectConfigurations) Create(ctx context.Context, ticketingProjectID string, opts ...operations.Option) (*operations.CreateTicketingProjectConfigurationResponse, error) {
	...
	res := &operations.CreateTicketingProjectConfigurationResponse{
...
func (s *ProjectConfigurations) Get(ctx context.Context, ticketingProjectID string, configID string, opts ...operations.Option) (*operations.GetTicketingProjectConfigResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
