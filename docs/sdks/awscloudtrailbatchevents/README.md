...
* [List](#list) - List events for an AWS CloudTrail batch
...
**[*operations.GetAwsCloudtrailBatchEventsResponse](../../models/operations/getawscloudtrailbatcheventsresponse.md), error**
