...
type ProcessingLogEntries struct {
	sdkConfiguration sdkConfiguration
}

func newProcessingLogEntries(sdkConfig sdkConfiguration) *ProcessingLogEntries {
	return &ProcessingLogEntries{
		sdkConfiguration: sdkConfig,
	}
}

// Get - Processing Log Entries for a specific alert
// Processing Log Entries for a specific alert
func (s *ProcessingLogEntries) Get(ctx context.Context, request operations.GetV1ProcessingLogEntriesRequest, opts ...operations.Option) (*operations.GetV1ProcessingLogEntriesResponse, error) {
	...
	res := &operations.GetV1ProcessingLogEntriesResponse{
