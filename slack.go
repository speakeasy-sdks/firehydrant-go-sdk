...
func newSlack(sdkConfig sdkConfiguration) *Slack {
	return &Slack{
...
func (s *Slack) CreateEmojiAction(ctx context.Context, connectionID string, requestBody operations.CreateSlackEmojiActionRequestBody, opts ...operations.Option) (*operations.CreateSlackEmojiActionResponse, error) {
...
func (s *Slack) UpdateEmojiAction(ctx context.Context, connectionID string, emojiActionID string, requestBody *operations.UpdateSlackEmojiActionRequestBody, opts ...operations.Option) (*operations.UpdateSlackEmojiActionResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Slack) ListUsergroups(ctx context.Context, opts ...operations.Option) (*operations.ListSlackUsergroupsResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
